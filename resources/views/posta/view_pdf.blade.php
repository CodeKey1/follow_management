                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card card-secondary">
                                    <div class="card-header">
                                        <h4> جهة الوارد : <span> ( رئاسة الجمهورية )</span> </h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row col-md-12">
                                            <div class=" col-md-4">
                                                <h6 style="float: left;"> التاريخ : <span> ( 2019-11-28 )</span> </h6>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <h6> رقم المكاتبة : <span> ( 23131 )</span> </h6>
                                            </div>
                                            <div class="form-group col-md-4">
                                            </div>
                                        </div>
                                        <div class="row col-md-12" style="margin-top: -25px;">
                                            <div class=" col-md-4">
                                                <h6 style="float: left;"> تاريخ الوارد : <span> ( 2019-11-28 )</span>
                                                </h6>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <h6> رقم المكتب : <span> ( 55 )</span> </h6>
                                            </div>
                                            <div class="form-group col-md-4">
                                            </div>
                                        </div>
