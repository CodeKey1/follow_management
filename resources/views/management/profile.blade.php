            ...
            <div class="main-content">
                <nav aria-label="breadcrumb" style="direction: rtl;">
                    <ol class="breadcrumb text-white-all" style="background-color: #353c48 !important;padding: 20px;">
                      ...
                      <li class="breadcrumb-item"><a href="{{route('manage')}}"><i class="far fa-file"></i> كل الإدارات المسؤلة </a></li>
                      <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i> متابعة الإدارة </li>
                    </ol>
                  </nav>
                            ...
                            <div class="col-12 col-md-12 col-lg-4">
                                ...
                                <div class="card card-secondary">
                                    <div class="card-header">
                                        <h4> إحصائيات الإداراة المسؤلة للمتابعة </h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="py-4">
                                            <p class="clearfix">
                                    ...
                                    <div class="padding-20">
                                        ...
                                        <div class="tab-content tab-bordered" id="myTab3Content">
                                            ...
                                            <div class="tab-pane fade" id="settings" role="tabpanel"
                                                ...
                                                <form class="needs-validation" id="work_experience" novalidate=""action="{{ route('manage.update',$responsible->id) }}" method="POST" enctype="multipart/form-data">
                                                  @csrf
                                                    <div class="card-header">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12 col-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $responsible->name }}" name="name" required>
